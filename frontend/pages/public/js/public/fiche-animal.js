document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const resAnimal = await fetch(`https://zoo-arcadia-app-production.up.railway.app/api/animals`);
        ...
        await fetch(`https://zoo-arcadia-app-production.up.railway.app/api/statistiques/increment/${animal.id}`, {
        ...
        const resImages = await fetch(`https://zoo-arcadia-app-production.up.railway.app/api/animals/${animalId}/images`);
        ...
        const resRapports = await fetch(`https://zoo-arcadia-app-production.up.railway.app/api/public/rapports-veterinaires/${animalId}`);
  ...
  `;
        ...
        const resVues = await fetch(`https://zoo-arcadia-app-production.up.railway.app/api/consultations`);
